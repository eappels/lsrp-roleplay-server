...
const coordsSectionEl = document.getElementById('coords-section');
...
function setVisible(isVisible) {
	rootEl.classList.toggle('is-hidden', !isVisible);
...
function renderHud(payload) {
	...
	const showCoordinates = payload.showCoordinates === true;
	...
	setHidden(coordsSectionEl, !showCoordinates);
