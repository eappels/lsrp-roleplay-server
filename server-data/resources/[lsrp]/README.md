...
- [lsrp_taxi](lsrp_taxi/README.md): Taxi depot, fares, and the first civilian driving job.
...
`lsrp_vehicleparking` also includes additional docs:
...
## Third-Party Resources In This Folder

These are present in the same folder but are not documented here as custom LSRP resources:
